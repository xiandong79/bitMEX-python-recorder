...
class BitMEXWebsocket:
    ...
    def recent_trades(self):
        '''Get recent trades.'''
        # {'timestamp': '2019-01-05T11:31:45.560Z', 'symbol': 'XBTUSD', 'side': 'Sell', 'size': 100, 'price': 3818.5, 'tickDirection': 'ZeroMinusTick', 'trdMatchID': '829c01f2-8594-9a45-8cf2-aeb48a3ca122', 'grossValue': 2618800, 'homeNotional': 0.026188, 'foreignNotional': 100}
        return [list(item.values()) for item in self.data['trade']]
